<template>
  <a
    v-if="whatsappNumber"
    :href="`https://wa.me/${whatsappNumber}?text=Hi!%20I%20am%20interested%20in%20your%20properties.`"
    target="_blank"
...
const whatsappNumber = computed(() => websiteSettings.data?.whatsapp_number || '911234567890')
</script>
